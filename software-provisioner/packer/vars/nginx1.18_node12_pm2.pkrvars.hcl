version            = "v0.1"
ami_name           = "packer-nginx1.18-nodejs12-pm2-ami"
ami_description    = "Nginx, Node.js & PM2 on Amazone Linux in AWS EC2."
playbook_file_path = "../../playbook/nginx1.18_node12_pm2.yml"
tags               = {
    Service = "DevOps"
}
