version            = "v0.1"
ami_name           = "packer-nginx1.18-python3-sqlite3-ami"
ami_description    = "Nginx, Python3 & sqlite3 on Amazone Linux in AWS EC2."
playbook_file_path = "../../playbook/nginx1.18_python3_sqlite3.yml"
tags               = {
    Service = "DevOps"
}
...
source_ami = "ami-0ef93af1d5156a18e" 
