version            = "v0.1"
ami_name           = "packer-apache-tomcat8.5-java8-ami"
ami_description    = "Apache, JAVA8 & Tomcat8.5 on Amazon-Linux in AWS EC2"
playbook_file_path = "playbook/apache-tomcat.yml"
tags               = {
    Service = "DevOps"
}
