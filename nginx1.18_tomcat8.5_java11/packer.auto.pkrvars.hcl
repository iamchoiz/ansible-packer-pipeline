version            = "v0.1"
ami_name           = "packer-nginx-tomcat8.5-java11-ami"
ami_description    = "Nginx, JAVA11 & Tomcat8.5 on Amazone Linux in AWS EC2."
playbook_file_path = "playbook/nginx-tomcat.yml"
tags               = {
    Service = "DevOps"
}
